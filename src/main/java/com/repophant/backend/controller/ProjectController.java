...
public class ProjectController {
  ...
  @Operation(
      summary = "Return a list of available projects",
      responses = {
  ...
  public ResponseEntity<Project> getProjectById(
      @Parameter(description = "ID of project to be searched") @PathVariable Long id) {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Accessing the resource you were trying to create is forbidden")
      })
  @PostMapping
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Accessing the resource you were trying to update is forbidden"),
        @ApiResponse(
            responseCode = "404",
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Accessing the resource you were trying to delete is forbidden"),
        @ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<Void> deleteProject(
      @Parameter(description = "ID of project to be deleted") @PathVariable Long id) {
